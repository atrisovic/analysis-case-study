...
FileCatalog().Catalogs = [ "xmlcatalog_file:/afs/cern.ch/work/a/atrisovi/analysis-case-study/Step1_getdata/MagUp-11/myCatalog.xml" ]
...
DaVinci().TupleFile     = "Stripping21r1_D2HMuMu"+year+"_Mag"+magPol+"_NTuples.root" 
