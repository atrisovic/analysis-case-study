...
void addBDT()
{
  TString fname="../Ntuples/D2hMuMu12_MagD_2PiMuMuOS_NTuple_Reduced.root";
  ...
  reader->AddVariable("min(muminus_IPCHI2_OWNPV,muplus_IPCHI2_OWNPV)", &var11);
  reader->AddVariable("max(muminus_IPCHI2_OWNPV,muplus_IPCHI2_OWNPV)", &var12);
  
  reader->AddVariable("D_PT", &var13);
  reader->AddVariable("D_FDCHI2_OWNPV", &var14);
...
/*
  ...
  */
/*
    "0" Expression="D_DIRA_OWNPV" Label="D_dira" Title="D_dira" 
    "1" Expression="D_IPCHI2_OWNPV" Label="D_ipchi" Title="D_ipchi" 
    "2" Expression="D_ENDVERTEX_CHI2" Label="D_edchi" Title="D_edchi" 
    "3" Expression="piplus_PT" Label="pi_pt" 
    "4" Expression="piplus_IPCHI2_OWNPV" Label="pi_ipchi" 
    "5" Expression="piplus_P" Label="pi_p" 
    "6" Expression="max(muminus_P,muplus_P)" Label="max_mu_p" 
    "7" Expression="min(muminus_P,muplus_P)" Label="min_mu_p" 
    "8" Expression="max(muminus_PT,muplus_PT)" Label="max_mu_pt" 
    "9" Expression="min(muminus_PT,muplus_PT)" Label="min_mu_pt" 
    "10" Expression="D_TAU" Label="D_tau" 
    "11" Expression="min(muminus_IPCHI2_OWNPV,muplus_IPCHI2_OWNPV)" Label="min_mu_ip" 
    "12" Expression="max(muminus_IPCHI2_OWNPV,muplus_IPCHI2_OWNPV)" Label="max_mu_ip" 
    "13" Expression="D_PT" Label="D_pt" 
    "14" Expression="D_FDCHI2_OWNPV" Label="D_fd" 
    "15" Expression="D_P" Label="D_p" 
*/

  //Ana: OK
  TString methodName = method;
  methodName += TString(" method"); 
  TString weightFile = "../Step4_TMVA/weights/TMVAClassification_BDT.weights.xml"; 
  ...
  for (Int_t i = 0; i<nentries; i++){
    ...
    var2 = D_endver_chi2;
    var3 = piplus_pt;      
    var4 = min(piplus_ipchi2_ownpv,piplus_p);  
    var5 = max(piplus_ipchi2_ownpv,piplus_p);  
    spect0 = muminus_p;
    spect1 = muplus_p;
