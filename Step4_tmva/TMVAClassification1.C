...
int TMVAClassification1( TString montecarlo, TString dataloc, TString myMethodList = "" )
{
   ...
   TString fnameMC_MD_11 = montecarlo + "/MC_D2PiMuMu12_MagDown_NTuples_fin.root";
   TString fnameMC_MU_11 = montecarlo + "/MC_D2PiMuMu12_MagUp_NTuples_fin.root";
   ...
   TString fnameRD = dataloc + "/D2PiMuMuOS.root";
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification1(argv[1], argv[2], methodList); 
}
