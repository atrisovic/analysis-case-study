...
// Do something!
void Main(TString sFile, TString sFolder, TString sTree) { //TString sOutput

	TString sOutput = "D2hMuMu11_MagU_2PiMuMuOS_NTuple_Reduced.root";
  ...
  /*  Data->SetBranchStatus("D_Hlt2CharmSemilepD2HMuMuWideMassDecision_TOS", 0); */
   ...
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNe", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNmu", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNpi", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNk", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNp", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV2_ProbNNghost", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNe", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNmu", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNpi", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNk", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNp", 0); */
   /* Data->SetBranchStatus("piplus_MC12TuneV3_ProbNNghost", 0); */
   /* Data->SetBranchStatus("piplus_CosTheta", 0); */
   Data->SetBranchStatus("piplus_OWNPV_X", 0);
   Data->SetBranchStatus("piplus_OWNPV_Y", 0);
   Data->SetBranchStatus("piplus_OWNPV_Z", 0);
   Data->SetBranchStatus("piplus_OWNPV_XERR", 0);
   Data->SetBranchStatus("piplus_OWNPV_YERR", 0);
   Data->SetBranchStatus("piplus_OWNPV_ZERR", 0);
   Data->SetBranchStatus("piplus_OWNPV_CHI2", 0);
   Data->SetBranchStatus("piplus_OWNPV_NDOF", 0);
   Data->SetBranchStatus("piplus_OWNPV_COV_", 0);
   /* Data->SetBranchStatus("piplus_IP_OWNPV", 0); */
   /* Data->SetBranchStatus("piplus_IPCHI2_OWNPV", 0); */
   Data->SetBranchStatus("piplus_ORIVX_X", 0);
   Data->SetBranchStatus("piplus_ORIVX_Y", 0);
   Data->SetBranchStatus("piplus_ORIVX_Z", 0);
   Data->SetBranchStatus("piplus_ORIVX_XERR", 0);
   Data->SetBranchStatus("piplus_ORIVX_YERR", 0);
   Data->SetBranchStatus("piplus_ORIVX_ZERR", 0);
   Data->SetBranchStatus("piplus_ORIVX_CHI2", 0);
   Data->SetBranchStatus("piplus_ORIVX_NDOF", 0);
   Data->SetBranchStatus("piplus_ORIVX_COV_", 0);
   /* Data->SetBranchStatus("piplus_P", 0); */
   /* Data->SetBranchStatus("piplus_PT", 0); */
   Data->SetBranchStatus("piplus_PE", 0);
   Data->SetBranchStatus("piplus_PX", 0);
   Data->SetBranchStatus("piplus_PY", 0);
   Data->SetBranchStatus("piplus_PZ", 0);
   Data->SetBranchStatus("piplus_M", 0);
   Data->SetBranchStatus("piplus_ID", 0);
   /* Data->SetBranchStatus("piplus_PIDe", 0); */
   /* Data->SetBranchStatus("piplus_PIDmu", 0); */
   /* Data->SetBranchStatus("piplus_PIDK", 0); */
   /* Data->SetBranchStatus("piplus_PIDp", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNe", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNk", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNp", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNpi", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNmu", 0); */
   /* Data->SetBranchStatus("piplus_ProbNNghost", 0); */
   Data->SetBranchStatus("piplus_hasMuon", 0);
   //Data->SetBranchStatus("piplus_isMuon", 0);
   Data->SetBranchStatus("piplus_hasRich", 0);
   Data->SetBranchStatus("piplus_hasCalo", 0);
   Data->SetBranchStatus("piplus_L0Global_Dec", 0);
   Data->SetBranchStatus("piplus_L0Global_TIS", 0);
   Data->SetBranchStatus("piplus_L0Global_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1Global_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1Global_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1Global_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1Phys_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1Phys_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1Phys_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2Global_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2Global_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2Global_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2Phys_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2Phys_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2Phys_TOS", 0);
   Data->SetBranchStatus("piplus_L0DiMuonDecision_Dec", 0);
   Data->SetBranchStatus("piplus_L0DiMuonDecision_TIS", 0);
   Data->SetBranchStatus("piplus_L0DiMuonDecision_TOS", 0);
   Data->SetBranchStatus("piplus_L0MuonDecision_Dec", 0);
   Data->SetBranchStatus("piplus_L0MuonDecision_TIS", 0);
   Data->SetBranchStatus("piplus_L0MuonDecision_TOS", 0);
   Data->SetBranchStatus("piplus_L0MuonHighDecision_Dec", 0);
   Data->SetBranchStatus("piplus_L0MuonHighDecision_TIS", 0);
   Data->SetBranchStatus("piplus_L0MuonHighDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonHighMassDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonHighMassDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonHighMassDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonLowMassDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonLowMassDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1DiMuonLowMassDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1SingleMuonHighPTDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1SingleMuonHighPTDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1SingleMuonHighPTDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackMuonDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackMuonDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackMuonDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackAllL0Decision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackAllL0Decision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt1TrackAllL0Decision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuSSDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuSSDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2PiMuMuSSDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuSSDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuSSDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilep3bodyD2KMuMuSSDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY1Decision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY1Decision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY1Decision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY2Decision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY2Decision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY2Decision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY3Decision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY3Decision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY3Decision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY4Decision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY4Decision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDY4Decision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedHeavyDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedHeavyDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDetachedHeavyDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonBDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonBDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonBDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonLowMassDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonLowMassDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonLowMassDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2DiMuonDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuDecision_TOS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuWideMassDecision_Dec", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuWideMassDecision_TIS", 0);
   Data->SetBranchStatus("piplus_Hlt2CharmSemilepD2HMuMuWideMassDecision_TOS", 0);
   Data->SetBranchStatus("piplus_TRACK_Type", 0);
   Data->SetBranchStatus("piplus_TRACK_Key", 0);
   //Data->SetBranchStatus("piplus_TRACK_CHI2NDOF", 0);
   Data->SetBranchStatus("piplus_TRACK_PCHI2", 0);
   Data->SetBranchStatus("piplus_TRACK_MatchCHI2", 0);
   //Data->SetBranchStatus("piplus_TRACK_GhostProb", 0);
   Data->SetBranchStatus("piplus_TRACK_CloneDist", 0);
   Data->SetBranchStatus("piplus_TRACK_Likelihood", 0);
   Data->SetBranchStatus("piplus_cpx_0.50", 0);
   Data->SetBranchStatus("piplus_cpy_0.50", 0);
   Data->SetBranchStatus("piplus_cpz_0.50", 0);
   Data->SetBranchStatus("piplus_cpt_0.50", 0);
   Data->SetBranchStatus("piplus_cp_0.50", 0);
   Data->SetBranchStatus("piplus_cmult_0.50", 0);
   Data->SetBranchStatus("piplus_cpx_0.60", 0);
   Data->SetBranchStatus("piplus_cpy_0.60", 0);
   Data->SetBranchStatus("piplus_cpz_0.60", 0);
   Data->SetBranchStatus("piplus_cpt_0.60", 0);
   Data->SetBranchStatus("piplus_cp_0.60", 0);
   Data->SetBranchStatus("piplus_cmult_0.60", 0);
   Data->SetBranchStatus("piplus_cpx_0.70", 0);
   Data->SetBranchStatus("piplus_cpy_0.70", 0);
   Data->SetBranchStatus("piplus_cpz_0.70", 0);
   Data->SetBranchStatus("piplus_cpt_0.70", 0);
   Data->SetBranchStatus("piplus_cp_0.70", 0);
   Data->SetBranchStatus("piplus_cmult_0.70", 0);
   Data->SetBranchStatus("piplus_cpx_0.80", 0);
   Data->SetBranchStatus("piplus_cpy_0.80", 0);
   Data->SetBranchStatus("piplus_cpz_0.80", 0);
   Data->SetBranchStatus("piplus_cpt_0.80", 0);
   Data->SetBranchStatus("piplus_cp_0.80", 0);
   Data->SetBranchStatus("piplus_cmult_0.80", 0);
   Data->SetBranchStatus("piplus_cpx_0.90", 0);
   Data->SetBranchStatus("piplus_cpy_0.90", 0);
   Data->SetBranchStatus("piplus_cpz_0.90", 0);
   Data->SetBranchStatus("piplus_cpt_0.90", 0);
   Data->SetBranchStatus("piplus_cp_0.90", 0);
   Data->SetBranchStatus("piplus_cmult_0.90", 0);
   Data->SetBranchStatus("piplus_cpx_1.00", 0);
   Data->SetBranchStatus("piplus_cpy_1.00", 0);
   Data->SetBranchStatus("piplus_cpz_1.00", 0);
   Data->SetBranchStatus("piplus_cpt_1.00", 0);
   Data->SetBranchStatus("piplus_cp_1.00", 0);
   Data->SetBranchStatus("piplus_cmult_1.00", 0);
  ...
  // Write to a new file
  TFile *New_File = new TFile(sOutput,"create");
