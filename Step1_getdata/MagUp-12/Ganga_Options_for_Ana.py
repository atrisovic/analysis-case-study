...
myApplication.user_release_area  = "/afs/cern.ch/work/a/atrisovi/anastudy/MagUp-12"		#Maybe
...
j.application.optsfile = [ File ( '/afs/cern.ch/work/a/atrisovi/anastudy/MagUp-12/DaVinci_Options_for_Ana.py' ) ] # The DaVinci options file you want to run

j.inputdata = j.application.readInputData("/afs/cern.ch/work/a/atrisovi/anastudy/MagUp-12/"+fileName) # The location of the data option file
