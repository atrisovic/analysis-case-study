...
// Fri Apr 28 23:02:47 2017 by ROOT version 6.08/02
// from TTree DecayTree/DecayTree
// found on file: root://eoslhcb.cern.ch//eos/lhcb/user/a/atrisovi/analysis-case-study/Step3_cuts/D2PiMuMuOS.root
//////////////////////////////////////////////////////////

#ifndef D2PimumuOS_class_h
#define D2PimumuOS_class_h
...
#ifdef D2PimumuOS_class_cxx
D2PimumuOS_class::D2PimumuOS_class(TTree *tree) : fChain(0) 
{
...
D2PimumuOS_class::~D2PimumuOS_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t D2PimumuOS_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t D2PimumuOS_class::LoadTree(Long64_t entry)
{
...
void D2PimumuOS_class::Init(TTree *tree)
{
...
Bool_t D2PimumuOS_class::Notify()
{
...
void D2PimumuOS_class::Show(Long64_t entry)
{
...
Int_t D2PimumuOS_class::Cut(Long64_t entry)
{
...
#endif // #ifdef D2PimumuOS_class_cxx
