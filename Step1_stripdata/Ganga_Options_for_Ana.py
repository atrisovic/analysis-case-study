...
myApplication.user_release_area  = "/var/clus/usera/trisovic/Analysis/"		#Maybe
...
j.name = "S21"+magPol+year+"MS" # This is just the name of the job in Ganga. You can change this to whatever you like.
j.application.optsfile = [ File ( '/var/clus/usera/trisovic/Analysis/DaVinci_Options_for_Ana.py' ) ] # The DaVinci options file you want to run

j.inputdata = j.application.readInputData("/var/clus/usera/trisovic/Analysis/"+fileName) # The location of the data option file
