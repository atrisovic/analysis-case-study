...
// Fri Apr 28 22:21:07 2017 by ROOT version 6.08/02
// from TTree DecayTree/DecayTree
// found on file: root://eoslhcb.cern.ch//eos/lhcb/user/a/atrisovi/analysis-case-study/Step3_cuts/D2KMuMuSS.root
//////////////////////////////////////////////////////////

#ifndef D2KmumuSS_class_h
#define D2KmumuSS_class_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   D2KmumuSS_class(TTree *tree=0);
   virtual ~D2KmumuSS_class();
...
#ifdef D2KmumuSS_class_cxx
D2KmumuSS_class::D2KmumuSS_class(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoslhcb.cern.ch//eos/lhcb/user/a/atrisovi/analysis-case-study/Step3_cuts/D2KMuMuSS.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoslhcb.cern.ch//eos/lhcb/user/a/atrisovi/analysis-case-study/Step3_cuts/D2KMuMuSS.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://eoslhcb.cern.ch//eos/lhcb/user/a/atrisovi/analysis-case-study/Step3_cuts/D2KMuMuSS.root:/D2KmumuSSTuple");
...
D2KmumuSS_class::~D2KmumuSS_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t D2KmumuSS_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t D2KmumuSS_class::LoadTree(Long64_t entry)
{
...
void D2KmumuSS_class::Init(TTree *tree)
{
...
void D2KmumuSS_class::Show(Long64_t entry)
{
...
Int_t D2KmumuSS_class::Cut(Long64_t entry)
{
...
#endif // #ifdef D2KmumuSS_class_cxx
