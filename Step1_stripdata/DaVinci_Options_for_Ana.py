...
#MuMulocation = 'Phys/Bs2MuMusLTUBLine/Particles'
#KKlocation = 'Phys/Bs2MuMusBs2KKLTUBLine/Particles'
#WideMasslocation = 'Phys/Bs2MuMusWideMassLine/Particles'
...
DaVinci().TupleFile     = "Stripping21_D2HMuMu"+year+"_Mag"+magPol+"_NTuples.root" # This is the name of the ntuple file that gets produced. You should change this to something more appropriate. It automatically includes the year and magnet polarity in the name.
